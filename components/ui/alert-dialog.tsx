...
export function useAlertDialog() {
  ...
  const openAlert = React.useCallback(() => setIsAlertVisible(true), []);
  const closeAlert = React.useCallback(() => setIsAlertVisible(false), []);
  const toggleAlert = React.useCallback(() => setIsAlertVisible((v) => !v), []);
  return { isAlertVisible, openAlert, closeAlert, toggleAlert };
}
